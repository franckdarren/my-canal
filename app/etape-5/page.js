...
export default function Etape5() {
    return (
        <div className="flex min-h-screen flex-col items-center pt-[20px] bg-black">
            ...
            <h2 className="font-bold text-[20px] text-center text-white pt-[20px] px-3">Cherchez une série jeunesse présente sur mycanal se trouvant sur les lieux et scannez le QR code en dessous. </h2>
