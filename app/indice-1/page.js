    ...
    return (
        <main className="flex min-h-screen flex-col items-center pt-[20px] bg-black">
            <div className="">
                ...
                <p className="mt-10 px-5 text-[20px] text-center text-white">Pour le prochain indice, trouvez le lieu où vous pouvez regarder MyCanal en streaming sur votre mobile tout en admirant la vue en étant assis.
                </p>
            </div>
