...
export default function Etape6() {
    return (
        <div className="flex min-h-screen flex-col items-center pt-[20px] bg-black">
            ...
            <h2 className="font-bold text-[20px] text-center text-white pt-[20px] px-3">Terminez votre aventure parmi les fleurs en découvrant les nouveautés et exclusivités de MyCanal.Scannez le QR code à l&apos;entrée pour débuter votre aventure MyCanal et découvrir une introduction spéciale.</h2>
